...
struct Connection
{
  ...
  void craq_forward_propagate_request(int index, int port, std::string_view key, std::string_view value, uint64_t version, uint64_t client_index, uint64_t client_port);
  void craq_backward_propagate_request(int index, int port, std::string_view key, uint64_t latest_clean_version, uint64_t client_index, uint64_t client_port);
  void craq_version_request(int index, int port, std::string_view key);
  void craq_version_response(int index, int port, std::string_view key, uint64_t version);
  void craq_version_request(int index, int port, std::string_view key, uint64_t client_index, uint64_t client_port);
  void craq_version_response(int index, int port, std::string_view key, std::string_view value, uint64_t version, uint64_t client_index, uint64_t client_port);
