    ...
    server.loop(
        [&](auto remote_index, auto remote_port, MachnetFlow &tx_flow, auto &&data)
        {
          ...
          else if (data.isCraqVersionRequest()) 
          {
            ...
            CRAQ_INFO("[CraqVersionRequest] [{}:{}] -> [{}:{}] Got version request for key {} with latest version {}", machine_index, remote_port, remote_index, remote_port, key, latest_version);
          ...
          else if (data.isCraqVersionResponse())
          {
            ...
            CRAQ_INFO("[CraqVersionResponse] [[{}:{}] -> [{}:{}] Got version response for key {} with latest version {}", machine_index, remote_port, client_index, client_port, key, tail_latest_version);
